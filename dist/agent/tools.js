...
export function createToolExecutors(ctx) {
    return {
        ...
        search_replace: async (args) => {
            const result = await ctx.editTools.searchReplace(args.path, args.search, args.replace, {
                all: args.all,
