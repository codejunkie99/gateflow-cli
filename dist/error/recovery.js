...
(function (RecoveryAction) {
    ...
    RecoveryAction["FALLBACK_MODEL"] = "fallback_model";
    RecoveryAction["SKIP_AND_CONTINUE"] = "skip_and_continue";
...
export class ErrorRecoveryPipeline {
     ...
     */
    shouldAskUser(errorType, context) {
     ...
     */
    async askUserForRecovery(errorType, context) {
