...
export class SVParser {
     ...
     */
    parseModules(cleanContent, originalContent, filePath) {
        const modules = [];
        // Reset regex
     ...
     */
    parsePackages(cleanContent, originalContent, filePath) {
        const packages = [];
     ...
     */
    parseInterfaces(cleanContent, originalContent, filePath) {
        const interfaces = [];
     ...
     */
    parseInstantiations(content, excludeModules) {
