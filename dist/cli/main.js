...
import { setupContext, chatCommand, scanCommand, lintCommand, fixCommand, watchCommand, generateCommand, doctorCommand, versionCommand } from './commands.js';
...
program
    ...
    const opts = program.opts();
    const ctx = await setupContext(opts);
    const exitCode = await generateCommand(ctx, type, name, cmdOpts);
    process.exit(exitCode);
});
// ============================================================================
// Doctor Command
