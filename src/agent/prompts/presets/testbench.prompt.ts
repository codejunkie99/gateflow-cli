...
export function buildTestbenchPrompt(moduleSpec: any): string {
    return new PromptBuilder()
        ...
        .addExample(
            'Simple clocked testbench',
            `module tb_${moduleSpec.name || 'dut'}();
  ...
  initial begin
    ...
    $dumpvars(0, dut);
            ...
            'Note: Variables declared at module scope, clock generated in always block'
        )
        .enableThinking()
        .setOutputFormat({
            format: 'text',
